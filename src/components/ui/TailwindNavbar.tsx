...
export default function TailwindNavbar() {
    ...
    const pages = [{name:'Hjem',path:"home"}, {name:'Galleri',path:"browse"},{name:'Blogg',path:"blog"},{name:'Favoritter',path:"favourites"},{name:'Om meg',path:"about"}];
