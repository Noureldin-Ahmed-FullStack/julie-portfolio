...
export default function WhoAmI() {
    return (
        <CenteredPage>
            <div className='grid sm:grid-cols-2 gap-8 w-5/6 md:w-5/6 lg:w-4/6 xl:w-4/6 2xl:w-3/6 my-24'>
